...
#define HMBDC_LOG_WARNING(x)	if (hmbdc::app::SyncLogger::initialized()) hmbdc::app::SyncLogger::instance().LOG_N(hmbdc::time::SysTime::now(), hmbdc::app::g_SyncLogLevelStr[3], #x "=", x,   hmbdc::app::LogTrailer(__FILE__, __LINE__))
#define HMBDC_LOG_CRITICAL(x)	if (hmbdc::app::SyncLogger::initialized()) hmbdc::app::SyncLogger::instance().LOG_N(hmbdc::time::SysTime::now(), hmbdc::app::g_SyncLogLevelStr[4], #x "=", x,   hmbdc::app::LogTrailer(__FILE__, __LINE__))
