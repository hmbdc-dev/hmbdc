...
constexpr char const*  const DefaultUserConfig = R"|(
{
    ...
    "pumpRunMode"                   : "auto",           "__pumpRunMode"                     : "auto - pumps are auto started at the Domain ctreation time; delayed - user will call startDelayedPumping() to start; manual - user will use own thread to call runOnce() each time",
